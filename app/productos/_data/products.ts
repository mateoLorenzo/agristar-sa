...
const logoFileMap: Record<string, string> = {
  STARECO: "STARECO.png",
  "STARXIFOP R LPU": "Starxifop R LPU.png",
  "CYD – X LC": "Cyd – X LC.png",
  "STARLIN 33": "Starlin 33.png",
  ECOTECH: "Ecotech.png",
  "BIONUTRIENTE CALCIO": "BIONUTRIENTE-CALCIO.png",
  "BIONUTRIENTE MULTIMINERAL": "bionutriente-multimineral.png",
  BELCOCEL: "BELCOCEL.png",
  "SEED + EXTRA": "SEED+EXTRA.png",
  AGROSTIM: "AGROSTIM.png",
  DIPI: "DIPI.png",
  STARBUZIN: "STARBUZIN.png",
  PID: "PID.png",
  STARFEN: "STARFEN.png",
  "TRAMPA PLATO": "TRAMPA DE FEROMONA.png",
  "TMP (Turbo Mata Picudo)": "tmp.png",
  ...
  "COMMAND 36": "command-2.png",
  "PROMETRINA 50": "PROMETRINA.png",
  MSMAX: "msmax.png",
  TALSTAR: "Talstar.png",
};
