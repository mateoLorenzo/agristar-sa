        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-4 lg:gap-4 mb-12 md:mb-16">
          ...
          <div className="order-1 lg:order-1 flex flex-col space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
              {/* Hoja de Seguridad */}
              <div className="bg-white border border-[#E5E7EB] rounded-lg hover:border-[#659C39] hover:bg-[#F9FAFB] transition-all cursor-pointer p-4 md:p-5 flex items-center gap-3 md:gap-4">
                <svg
